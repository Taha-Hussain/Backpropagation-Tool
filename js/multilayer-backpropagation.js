$(document).ready(function () {
    $('#calculate-btn').click(function () {
        ...
        var net1 = x1 * w11 + x2 * w12 + x3 * w13 + x4 * w14;
        var net2 = x1 * w21 + x2 * w22 + x3 * w23 + x4 * w24;
        ...
        $('#w14_updated').val((learning_rate * s1_hidden_layer * x4) + (+w14));
        ...
        $('#w24_updated').val((learning_rate * s2_hidden_layer * x4) + (+w24));
